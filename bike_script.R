...
bike_data$started_at<-ass_datetime(bike_data$started_at)
...
##creating new column called length of ride 
...
bike_data_2<-filter(bike_data,length_of_ride>=1)

##filtering out "docked_bike" (those are under maintenance)
